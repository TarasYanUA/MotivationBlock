...
public class DisplayElementForSpecifiedCategoriesOnlyTest extends TestRunner {
    ...
    public void checkCategoriesForMotivationElement() throws IOException {
        ...
        if (DriverProvider.getDriver().findElement(By.xpath("//p[text()='Все категории включены']")).isDisplayed()) {
            ...
            motivationBlock.chooseCategory_GameConsoles.click();
        ...
        storefront.scrollToMotivationBlock();
        System.out.println("600 'Our Advantages' is present at the product of 'Game consoles' category");
        storefront.selectLanguage("ar");
        storefront.scrollToMotivationBlock();
        System.out.println("602 'Our Advantages' is present at the product of 'Men cloth' category (RTL)");
        storefront.selectLanguage("ru");
        ...
        storefront.scrollToMotivationBlock();
        System.out.println("605 'Our Advantages' is present at the product of 'Men cloth' category");
        ...
        Assert.assertEquals(actualNumberOfTabs, 3,
                "Motivation element 'Our advantages' is present for a wrong category 'Apparel'!");
        storefront.scrollToMotivationBlock();
        takeScreenShot("610 Our advantages element is present for a wrong category 'Apparel'");
